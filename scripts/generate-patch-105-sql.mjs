...
const queries = [
  ...
  { file: "patch-105-query12-anti-regret-correlation.sql", title: "Q12 Correlação Anti-Regret", body: `select round(corr(anti_regret_score, user_value_score), 4) as correlacao, count(*)::bigint as eventos from outcomes where anti_regret_score is not null and user_value_score is not null;` },
