#!/usr/bin/env node
/**
 * PATCH 4A.11 — Regression runner (4A.4 through 4A.10 unit audits)
 */
...
const AUDITS = [
  ...
  { patch: "4A.10", label: "Multivariate Regression", script: "test-mia-patch-4a10-multivariate-audit.js" },
];

console.log("\nPATCH 4A.11 — Regression runner (4A.4 → 4A.10)\n");
