 ...
 * @property {string} id
 * @property {"summary"|"insight"|"trend"|"alert"|"recommendation"} analysis_type
 ...
 * @property {Array<{ section_id: string, title: string, content: string, priority_order: number, source_refs: string[] }>} sections
 * @property {Array<{ type: string, title: string, body: string, source_reference: string, priority: string|null }>} highlights
 * @property {string[]} priorities
 ...
 * @property {ExecutiveExplainability[]} [explainability]
 * @property {ExecutiveNarrative|null} [narrative]
