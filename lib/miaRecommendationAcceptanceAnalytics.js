...
import { scheduleAntiRegretFoundationFromPostDecisionSignal } from "./miaAntiRegretFoundationAnalytics.js";
import { scheduleUserValueOutcomeFromPostDecisionSignal } from "./miaUserValueOutcomeAnalytics.js";
...
export function observeAcceptanceSignalAnalytics(supabase, input = {}) {
  ...
  scheduleAntiRegretFoundationFromPostDecisionSignal(supabase, {
    decisionRequestId: input.decisionRequestId || input.requestId || null,
    analyticsContext: input.analyticsContext,
    controlledTest: input.controlledTest,
  });

  scheduleUserValueOutcomeFromPostDecisionSignal(supabase, {
    decisionRequestId: input.decisionRequestId || input.requestId || null,
    analyticsContext: input.analyticsContext,
    controlledTest: input.controlledTest,
  });
