...
import { attachContextualPriorityToSession } from "./miaContextualPriorityEngine.js";
...
export function persistExplicitRecommendationChangeToSession(
  ...
  return attachContextualPriorityToSession(out, {
    query: sessionContext?.lastQuery || "",
    category: sessionContext?.lastCategory || "",
    primaryAxis: out.lastPriority || out.lastAxis || "",
    activePriority: out.lastPriority || "",
  });
}
