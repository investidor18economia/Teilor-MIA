 ...
 */
function attachNarrativePlanOrdering(sources = {}, narrativePlan = null) {
  if (!narrativePlan?.sections?.length) {
    return { ...sources, narrativePlan: narrativePlan || sources.narrativePlan || null };
  }
