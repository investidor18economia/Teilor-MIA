...
export const CONTEXTUAL_DECISION_SYNTHESIS_VERSION = "4A.8.0";
...
export function buildContextualDecisionSynthesisPayload(input = {}) {
  ...
  return {
    ...
    practicalConsequences: synthesis.practicalConsequences || [],
    practicalConsequenceTrace: synthesis.practicalConsequenceTrace || null,
    contextualPriorityModel: priorityModel,
