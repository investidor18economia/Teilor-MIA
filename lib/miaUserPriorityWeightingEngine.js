...
const PRIORITY_SIGNAL_RULES = Object.freeze([
  {
    ...
    patterns: [
      ...
      /\b(bang for buck|relacao preco|rela[cç][aã]o pre[cç]o|preco qualidade|pre[cç]o qualidade)\b/i,
    ],
  ...
  },
  {
    ...
    patterns: [
      ...
      /\b(bateria|autonomia)\s+(melhor|boa|forte|grande)\b/i,
      /\b(dura|durar|segura|aguenta)\s+(mais|melhor|o dia|um dia|longe)\b/i,
      /\b(longe da tomada|carregar toda hora|carregando toda hora|nao quero carregar|n[aã]o quero carregar)\b/i,
    ],
  ...
  },
  {
    ...
    patterns: [
      /\b(confian[cç]a|certeza|seguran[cç]a|qualidade|foto|fotos|fotograf\w*|c[aâ]mera|camera|registrar)\b/i,
      /\b(camera boa|boa cam\b|foto e video|tira foto)\b/i,
    ],
