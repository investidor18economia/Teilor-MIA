...
const PHRASE_CANONICALIZATIONS = [
  ...
  [/(?<!\bentendi )(\b|^)ta ligado(\b|$)/g, "entendi", "acknowledgement"],
  [/(?<!\bentendi )(\b|^)to ligado(\b|$)/g, "entendi", "acknowledgement"],
  [/(\b|^)tlgd ne(\b|$)/g, "entendi", "acknowledgement"],
  [/(\b|^)tlgd(\b|$)/g, "entendi", "acknowledgement"],
