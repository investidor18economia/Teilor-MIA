...
export const UNIFIED_CONVERSATION_EGRESS_VERSION = "5.3.0";
...
export function prepareSocialEgressFinalization(
  ...
  return {
    ...
    finalizeResult,
    universalContract,
    finalizationMeta: buildHonestFinalizationMetadata(finalizeResult, EGRESS_FINALIZER_KIND.SOCIAL),
  };
}
...
export function wrapSocialFinalizationForEgress(
  ...
  return {
    ...
    universalContract,
    finalizationMeta: buildHonestFinalizationMetadata(finalized, EGRESS_FINALIZER_KIND.SOCIAL),
  };
}
...
export function prepareCommercialEgressEnvelope(body = {}, context = {}) {
  ...
  return {
    ...
    finalizationMeta: {
      ...
      usedFallback: emptyGuardApplied,
      repairApplied: false,
      emptyGuardApplied,
      emptyGuardReason,
    },
