...
export const EXECUTIVE_ANALYST_PHASE_C_ROADMAP = Object.freeze([
  ...
  { patch: "C.2", title: "Resumos Executivos Automáticos", scope: "ExecutiveSummaryBuilder — deterministic summaries" },
  { patch: "C.3", title: "Insights Inteligentes", scope: "ExecutiveInsightBuilder — deterministic insights" },
  { patch: "C.4", title: "Tendências Executivas", scope: "ExecutiveTrendBuilder — deterministic trends" },
  { patch: "C.5", title: "Alertas Estratégicos Priorizados", scope: "ExecutiveAlertBuilder — deterministic prioritized alerts" },
  { patch: "C.6", title: "Recomendações Acionáveis", scope: "ExecutiveRecommendationBuilder — deterministic recommendations" },
...
export const EXECUTIVE_ANALYST_LEGACY_BOUNDARY = Object.freeze({
  ...
  phase_c: "C.2 SummaryBuilder + C.3 InsightBuilder — lib only; does not modify 11.4/B.7 UI",
});
