...
import { extractProductMentionFromQuery } from "./miaProductIdentityResolution.js";
...
function cleanComparisonTerm(part = "") {
  ...
  const isolated = extractProductMentionFromQuery(part);

  return cleanText(isolated || part)
