...
function emitStage(supabase, metadata, analyticsContext, controlledTest, options = {}) {
  if (options.awaitInsert) {
    return emitPriceAlertLifecycleAnalytics(supabase, {
      metadata,
      analyticsContext,
      controlledTest,
    });
 ...
 * }} input
 */
export async function instrumentPriceAlertLifecycleFromCreation(supabase, input = {}) {
