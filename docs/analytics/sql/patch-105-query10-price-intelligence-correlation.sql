-- PATCH 10.5 — Q10 Correlação Price Intelligence
...
select price_quality, price_confidence, round(avg(user_value_score), 2) as score_medio, count(*)::bigint as eventos from outcomes group by 1, 2 order by eventos desc;
