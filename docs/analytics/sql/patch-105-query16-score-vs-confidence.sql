-- PATCH 10.5 — Q16 Score vs confidence
...
select value_confidence, round(avg(user_value_score), 2) as score_medio, count(*)::bigint as eventos from outcomes group by 1 order by score_medio desc nulls last;
