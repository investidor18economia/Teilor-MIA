-- PATCH 10.5 — Q19 Distribuição provider
...
select winner_provider_id as provider_id, round(avg(user_value_score), 2) as score_medio, count(*)::bigint as eventos from outcomes where winner_provider_id <> 'UNKNOWN' group by 1 order by eventos desc limit 30;
