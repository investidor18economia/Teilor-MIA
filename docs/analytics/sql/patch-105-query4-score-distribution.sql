-- PATCH 10.5 — Q4 Distribuição do score
...
select width_bucket(user_value_score, 0, 100, 10) as bucket, count(*)::bigint as eventos from outcomes where user_value_score is not null group by 1 order by 1;
