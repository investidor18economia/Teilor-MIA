-- PATCH 10.5 — Q9 Componentes do score
...
select value_component_count, round(avg(user_value_score), 2) as score_medio, count(*)::bigint as eventos from outcomes group by 1 order by 1;
