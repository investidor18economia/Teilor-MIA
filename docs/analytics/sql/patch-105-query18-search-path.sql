-- PATCH 10.5 — Q18 Distribuição search_path
...
select search_path, round(avg(user_value_score), 2) as score_medio, count(*)::bigint as eventos from outcomes group by 1 order by eventos desc;
