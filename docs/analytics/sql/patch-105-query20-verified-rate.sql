...
select value_status, count(*) filter (where verified_value_amount is not null)::bigint as com_verified_amount, count(*)::bigint as total from outcomes group by 1 order by 1;
