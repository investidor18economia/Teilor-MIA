...
select (created_at at time zone 'UTC')::date as dia, event_name, count(*)::bigint as eventos from phase10 group by 1, 2 order by 1 desc, 3 desc limit 60;
