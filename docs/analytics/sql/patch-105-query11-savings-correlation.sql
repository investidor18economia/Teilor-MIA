-- PATCH 10.5 — Q11 Correlação Savings
...
select savings_type, round(avg(potential_value_amount), 2) as potential_avg, count(*)::bigint as eventos from outcomes group by 1 order by eventos desc;
