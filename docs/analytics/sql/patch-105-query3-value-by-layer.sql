-- PATCH 10.5 — Q3 Valor por categoria/layer
...
select value_layer, round(avg(potential_value_amount), 2) as potential_avg, count(*)::bigint as eventos from outcomes group by 1 order by eventos desc;
