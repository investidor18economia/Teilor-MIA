-- PATCH 10.5 — Q2 Valor observado médio
...
select round(avg(observed_value_amount), 2) as observed_avg, count(*)::bigint as eventos from outcomes where observed_value_amount is not null;
