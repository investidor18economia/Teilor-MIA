-- PATCH 10.5 — Q17 Evolução temporal
...
select (created_at at time zone 'UTC')::date as dia, round(avg(user_value_score), 2) as score_medio, count(*)::bigint as eventos from outcomes group by 1 order by 1 desc limit 30;
