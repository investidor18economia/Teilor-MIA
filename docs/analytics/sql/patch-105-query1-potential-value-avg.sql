-- PATCH 10.5 — Q1 Valor potencial médio
...
select round(avg(potential_value_amount), 2) as potential_avg, count(*)::bigint as eventos from outcomes where potential_value_amount is not null;
